...
REM 64-bit build
cl %compilerFlags% %warnings% %buildFlags% -Fmmetagen.map -LD "src/metagen.c" -link %linkerFlags%

cl %compilerFlags% %warnings% %buildFlags% -Fmtest_app.map -LD "src/test_app.c" -link %linkerFlags%
popd
